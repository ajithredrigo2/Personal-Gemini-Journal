    ...
    <div className="min-h-[calc(100vh-4rem)] flex flex-col justify-between py-12 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      ...
      <div className="text-center max-w-3xl mx-auto pt-4 sm:pt-8">
        ...
        <motion.div
          ...
          className="mt-10 flex flex-col items-center justify-center gap-4 max-w-xl mx-auto"
        >
          ...
          <div className="w-full flex flex-col sm:flex-row items-center justify-center gap-3">
            {onOpenRegister && (
              <button
                ...
                className="w-full sm:w-auto h-12 inline-flex items-center justify-center gap-2.5 px-6 sm:px-7 bg-[#4E5038] hover:bg-[#3F412D] text-white rounded-full text-sm font-semibold border border-[#3E402B] shadow-sm hover:shadow-md hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 group cursor-pointer"
              >
            ...
            <button
              ...
              className="w-full sm:w-auto h-12 inline-flex items-center justify-center gap-2.5 px-6 sm:px-7 bg-white hover:bg-[#FAF9F5] text-[#2E2E2A] hover:text-[#181816] rounded-full text-sm font-semibold border border-[#D5D4CC] hover:border-[#BFBEB3] shadow-sm hover:shadow-md hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 disabled:opacity-75 disabled:cursor-not-allowed group cursor-pointer"
            >
              {isAuthenticating ? (
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5 pt-0.5">
            {onDemoSignIn && (
              <button
                ...
                className="h-8.5 inline-flex items-center gap-1.5 px-3.5 bg-white/70 hover:bg-white text-[#4A4B37] rounded-full border border-[#DCDAD0] hover:border-[#BFBEB2] shadow-2xs hover:shadow-xs transition-all cursor-pointer text-xs font-medium"
              >
            ...
            <button
              ...
              className="h-8.5 inline-flex items-center gap-1.5 px-3.5 bg-white/70 hover:bg-white text-[#57564F] hover:text-[#282723] rounded-full border border-[#DCDAD0] hover:border-[#BFBEB2] shadow-2xs hover:shadow-xs transition-all cursor-pointer text-xs font-medium"
            >
              <Shield className="w-3.5 h-3.5 text-[#73726B]" />
